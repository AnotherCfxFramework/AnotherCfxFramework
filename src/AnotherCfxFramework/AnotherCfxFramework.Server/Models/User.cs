...
using AnotherCfxFramework.Server.Database;
using CitizenFX.Core;
using System.Threading;

namespace AnotherCfxFramework.Server.Models
{
    public class User
    {
        ...
        // Aliases
        public int Ping => Natives.Call<int>(Hash.GET_PLAYER_PING, NetID);
        public int LastMsg => Natives.Call<int>(Hash.GET_PLAYER_LAST_MSG, NetID);
        public string EndPoint => Natives.Call<string>(Hash.GET_PLAYER_ENDPOINT, NetID);
        public void Kick(string reason) => Natives.Call(Hash.DROP_PLAYER, NetID, reason);
        ...
        public User(Player player)
        {
            ...
            // Fetch identities
            int numIdents = Natives.Call<int>(Hash.GET_NUM_PLAYER_IDENTIFIERS, NetID);
            List<string> idents = new List<string>();

            for (int i = 0; i < numIdents; i++)
            {
                idents.Add(Natives.Call<string>(Hash.GET_PLAYER_IDENTIFIER, NetID, i));
            }
        ...
        public async void SetPrivilege(Privilege Privilege, bool targetState)
        {
            try
            {
                ...
                {
                    using (var conn = Database.Database.connection)
                    {
        ...
        */
        ...
        public void TriggerEvent(string eventName, params object[] args)
        {
            ...
            unsafe
            {
                ...
                {
                    Natives.Call(Hash.TRIGGER_CLIENT_EVENT_INTERNAL, eventName, NetID, serialized, argsSerialized.Length);
                }
            }
        }
        */
        ...
        */
        ...
        {
            Events.TriggerClientEvent("Session.PlayerLeft", Player, reason);
